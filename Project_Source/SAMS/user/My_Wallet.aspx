<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="My_Wallet.aspx.cs" Inherits="paytm.My_Wallet" %>
...
<li class="dropdown dropdown-main  " >
									        	...
									        	<ul class="dropdown-menu dropdown-subhover dropdown-animation animated fadeIn">
									            	<li  class="active"><a href="My_Wallet.aspx"><i class="fa fa-bookmark"></i> Add Money</a></li>
...
<div class="alert alert-danger alert-danger-rw alert-dismissible" role="alert">
    ...
    <asp:Label Text="text"  ID="money" runat="server" />
					...
					<div class="col-sm-12 mt40">
						<h3 class="text-center no-margin mb20-xs">Add Money To Wallet</h3>
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-7"><div class="input-group">
										...
										<input class="form-control checkout-form-border" required="required" runat="server" min="1" id="AddMoney"  placeholder="Add Amount" type="number">
									</div></div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-7"><div class="input-group">
										...
										<input class="form-control checkout-form-border" required="required" id="pass" runat="server"  placeholder="Password" type="password">
									</div></div>
								</div>
								...
								<div class="col-sm-7 col-sm-offset-3">
									...
									<div class="col-sm-6 text-right mt10">
                                        ...
                                        <asp:Button  class="btn btn-rw btn-primary btn-lg" ID="Button1" OnClick="Button1_Click" runat="server" Text="Add Amount" />
