<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transfer.aspx.cs" Inherits="paytm.user.Transfer" %>
...
<li class="dropdown dropdown-main  " >
									        	<a href="#" class="dropdown-toggle  " style="color:#00B7EB" data-toggle="dropdown"><span class="ion-android-inbox fa-lg"></span> Wallet Details<span class="ion-android-dropdown fa-lg"></span></a>
									        	<ul class="dropdown-menu dropdown-subhover dropdown-animation animated fadeIn">
									            	<li  ><a href="My_Wallet.aspx"><i class="fa fa-bookmark"></i> Add Money</a></li>
									            	<li class="active"><a href="Transfer.aspx"><i class="fa fa-briefcase"></i> Transfer Money</a></li>
...
<div class="alert alert-danger alert-danger-rw alert-dismissible" role="alert">
    ...
    <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
                ...
                <asp:Panel ID="Panel2" Visible="false" runat="server">
                    <div class="alert alert-success alert-success-rw alert-dismissible" role="alert">
                        ...
                        <a href="Transfer.aspx" style="float:right;color:white">×</a>
    ...
    <asp:Label Text="text"  ID="money" runat="server" />
					...
					<div class="col-sm-12 mt40">
						<h3 class="text-center no-margin mb20-xs">Transfer Money From Wallet To Wallet</h3>
							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-sm-7"><div class="input-group">
										...
										<input class="form-control checkout-form-border" required="required" runat="server" id="AddMoney"  placeholder="Add Amount" type="number">
									</div></div>
								</div>

								<div class="form-group">
									<label class="col-sm-3 control-label" for="card-number">Your Unique Id</label>
									<div class="col-sm-7"><div class="input-group">
							                    <div class="input-group-addon"><i class="fa fa-user"></i></div>
																			<input class="form-control checkout-form-border" required="required" id="Text1" runat="server" placeholder="Your Unique ID" type="text">
									</div></div>
								</div>
