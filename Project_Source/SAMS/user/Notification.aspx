<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notification.aspx.cs" Inherits="paytm.user.Notification" %>
...
<li class="dropdown dropdown-main " >
                ...
                <asp:Panel ID="Panel2" Visible="false" runat="server">
                    <div class="alert alert-success alert-success-rw alert-dismissible" role="alert">
                        ...
                        <a href="Notification.aspx" style="float:right;color:white">×</a>


							 	<b>Bingo !</b> Notification has been deleted.
							</div>
