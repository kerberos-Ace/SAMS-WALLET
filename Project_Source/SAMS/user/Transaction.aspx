<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transaction.aspx.cs" Inherits="paytm.user.Transaction" %>
									...
									<nav class="navbar-collapse collapse navHeaderCollapse" role="navigation">
										...
										<li class="dropdown dropdown-main " >
									        	...
									        	<ul class="dropdown-menu dropdown-subhover dropdown-animation animated fadeIn">
									            	...
									            	<li class="active"><a href="Transaction.aspx?mname=0"><span class="ion-android-display fa-lg"></span> Transactions</a></li>
