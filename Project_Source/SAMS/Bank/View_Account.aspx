<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="View_Account.aspx.cs" Inherits="paytm.Bank.View_Account" %>
	    ...
	    <div class="boxed">
                ...
                <asp:Panel ID="Panel2" Visible="false"  runat="server">
                    <div class="alert alert-success alert-success-rw alert-dismissible" role="alert">
                        ...
                        <a href="View_Account.aspx" style="float:right;color:white" >×</a>

							 	<b>Bingo!</b> Account has been deleted.
							</div>
               ...
               <form runat="server">
				<div class="row">
					<div class="col-sm-12 mt40">
						<h3 class="text-center no-margin mb20-xs">Account Details</h3>
