<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Coupon_Details.aspx.cs" Inherits="paytm.Admin.Coupon_Details" %>
				...
				<div id="portfolio" class="container">
					...
					<div class="row" data-sr="enter right">
						<div class="col-xs-4 col-xs-offset-4 text-center mb10">
							<div class="heading"><h4>Coupons</h4></div>
						</div>
					</div>

					<!-- Portfolio Filter -->
					<div data-sr="enter left" class="row mb30">
						<ul class="nav nav-pills col-xs-12 text-center" runat="server" id="na_bar">
					...
					<!-- Portfolio Items -->
					<div class="row">
						<ul id="myPortfolio" runat="server" class="col-sm-12 no-padding text-center">
							<!-- Begin Item 1 -->
