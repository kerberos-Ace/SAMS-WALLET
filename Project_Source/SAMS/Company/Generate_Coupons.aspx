<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Generate_Coupons.aspx.cs" Inherits="paytm.Company.Generate_Coupons" %>
...
<li class="dropdown dropdown-main " >
									        	...
									        	<ul class="dropdown-menu dropdown-subhover dropdown-animation animated fadeIn">
									            	<li class="active" ><a href="Generate_Coupons.aspx"> <span class="ion-android-archive fa-lg"></span> Generate Coupons</a></li>
...
<div class="alert alert-danger alert-danger-rw alert-dismissible" role="alert">
    ...
    <a href="#" class="close" data-dismiss="alert"><span aria-hidden="true">×</span><span class="sr-only">Close</span></a>
							 	<b>Alert ! </b> Please try again. Coupon Code already exist.
							</div></asp:Panel>
                <asp:Panel ID="Panel2" Visible="false" runat="server">
                    <div class="alert alert-success alert-success-rw alert-dismissible" role="alert">
                        ...
                        <a  class="close" data-dismiss="alert">×<span class="sr-only">Close</span></a>
							 	...
							 	<b>Bingo!</b> Coupon has been generated.<br />
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12 mt40">
						<h3 class="text-center no-margin mb20-xs">Generate Coupons</h3>
						...
						<form class="form-horizontal"  runat="server">
							<fieldset>
                                ...
                                <div class="form-group">
									<label class="col-sm-3 control-label" for="card-holder-name">Company Name</label>
									<div class="col-sm-7"><div class="input-group">
							                    <div class="input-group-addon"><span class="ion-android-social" ></span></div>
										<input class="form-control checkout-form-border" id="Number2" disabled="disabled" runat="server"    placeholder="Company Name" type="text">
									</div></div>
								</div>

								<div class="form-group">
									<label class="col-sm-3 control-label" for="card-holder-name">Discount / Cashback</label>
									<div class="col-sm-7"><div class="input-group">
							                    <div class="input-group-addon"><span class="ion-android-promotion" ></span></div>
										<input class="form-control checkout-form-border" id="discount" runat="server" required="required" min="1" max="100"   placeholder="Discount / Cashback" type="number">
									</div></div>
								</div>
								...
								<div class="col-sm-7 col-sm-offset-3">
									...
									<div class="col-sm-6 text-right mt10">
                                        ...
                                        <asp:Button class="btn btn-rw btn-primary btn-lg" OnClick="Button1_Click" ID="Button1" runat="server" Text=" Generate Coupon" />
