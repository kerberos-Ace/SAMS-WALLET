<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gas_Wallet.aspx.cs" Inherits="paytm.GasBook.Gas_Wallet" %>
    ...
    <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
                ...
                <asp:Panel ID="Panel2" Visible="false" runat="server">
                    <div class="alert alert-success alert-success-rw alert-dismissible" role="alert">
                        ...
                        <a href="Gas_Wallet.aspx" style="float:right;color:white">×</a>
