<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notification.aspx.cs" Inherits="paytm.GasBook.Notification" %>
	    ...
	    <div class="boxed">
								...
								<div class="col-sm-12 column-header">
									<div class="navbar-header">
										...
										<a href="#" class="navbar-brand">
											<div ><span class="ion-android-locate fa-lg"></span> <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label> <span class="ion-android-locate fa-lg"></span></div>
										</a>
										<!-- Mobile Navigation -->
									...
									<nav class="navbar-collapse collapse navHeaderCollapse" role="navigation">
										<ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li class="active" >
									        	<a   href="Notification.aspx?mname=1" ><span class="ion-android-forums fa-lg"></span> Notification</a>
											...
											<li >
									        	<a   href="Gas_Wallet.aspx" ><span class="ion-android-inbox fa-lg"></span> Wallet</a>
              ...
              <asp:Panel ID="Panel2" Visible="false" runat="server">
                    <div class="alert alert-success alert-success-rw alert-dismissible" role="alert">
                        ...
                        <a href="Notification.aspx?mname=1" style="float:right;color:white">×</a>


							 Gas has been dispatched.
							</div>
				...
				<div class="row">
                  	...
                  	<div class="col-sm-12 mt40">
                          <div class="btn-group  btn-group-lg  col-lg-offset-4">
								  <a href="Notification.aspx?mname=1" runat="server" id="a1" class="btn btn-rw btn-danger ">All</a>
                                <a href="Notification.aspx?mname=2" runat="server" id="a2" class="btn btn-rw btn-danger ">Dispatched</a>	
                              <a href="Notification.aspx?mname=3" runat="server" id="a3" class="btn btn-rw btn-danger">Pending</a>
								</div>
